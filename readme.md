## Hi there 👋
I'm a passionate researcher working for **autonomous road safety**. My research aims at **safer traffic for all road users utilising automated technologies**, which include but are not limited to autonomous driving, decentralized risk management, and data-driven improvement of mobility systems.

I have a mixed education background in Operations Research and Management Information Systems; self-taught knowledge in Data Science, Machine Learning, Deep Learning, and Reinforcement Learning; as well as solution-driven skills in Artificial Intelligence by addressing theoretical and practical problems. My scientific interests are generally in collective patterns emerged in individual interactions, of which the curiousity motivated my pursuit of a doctoral degree. Being part of [Delft AI Labs & Talent Programme](https://www.tudelft.nl/en/ai/research-innovation/labs-projects), I obtained my doctorate with Cum Laude (less than 4\%) at Delft University of Technology, with my PhD Thesis titled ["Proactive Collision Risk Quantification in Multi-directional Traffic Interactions"](https://research.tudelft.nl/en/publications/proactive-collision-risk-quantification-in-multi-directional-traf/). Most of my papers published during PhD are openly accessible thanks to the TU Delft Library. For every paper, code for experiments and instructions to reproduce the results are open-sourced here on GitHub. Below is a more detailed list, where I
...
- presented structure-preserving contrastive learning for geospatial time series to learn representations that facilitate downstream tasks [\[code\]](https://github.com/Yiru-Jiao/spclt)[\[pdf\]](https://doi.org/10.1016/j.ait.2025.100031),
- developed a scalable, context-aware, and generalisable approach to learn the collision risk in traffic interactions from naturalistic driving [\[code\]](https://github.com/Yiru-Jiao/GSSM)[\[pdf\]](https://doi.org/s42256-026-01189-w).

I enjoy thinking, reading, and writing (in both machine and human language), although unfavourably my mind gets overloaded sometimes. I actively post work-relevant updates on [LinkedIn](https://www.linkedin.com/in/yiru-%E8%89%BA%E8%8C%B9-jiao-%E7%84%A6-697620ba/) and other thoughts in my WeChat Moments. 
...
- [EthiX](https://github.com/Yiru-Jiao/EthiX) an interactive, scenario-based simulation game designed to raise awareness of research integrity among graduate students and researchers.
